...
const routes = [
  ...
  { method: 'POST', path: /^\/api\/workflows\/([^/]+)\/control\/query$/, handlerName: 'handleWorkflowControlQuery', mapParams: ['workflow_id'] },
  { method: 'POST', path: /^\/api\/workflows\/([^/]+)\/control\/signal$/, handlerName: 'handleWorkflowControlSignal', mapParams: ['workflow_id'] },
  { method: 'POST', path: /^\/api\/workflows\/([^/]+)\/control\/update$/, handlerName: 'handleWorkflowControlUpdate', mapParams: ['workflow_id'] },
