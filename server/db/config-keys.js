...
const VALID_CONFIG_KEYS = new Set([
  ...
  'ollama_balanced_model_fallback',
  'ollama_fallback_provider',
  'ollama_fast_model',
  'ollama_fast_model_fallback',
  ...
  'ollama_quality_model_fallback',
  'ollama_repeat_penalty',
  'ollama_temperature',
  'ollama_top_k',
  'ollama_top_p',
  'ollama_agentic_first_response_timeout_seconds',
  'ollama_cloud_agentic_first_response_timeout_seconds',
  'openai_api_key',
  'openrouter_agentic_first_response_timeout_seconds',
  'agentic_first_response_timeout_seconds',
  'output_limits_enabled',
  'overflow_max_complexity',
  'provider_stats_enabled',
  'quality_scoring_enabled',
  'rate_limiting_enabled',
  'reject_recovery_age_threshold_ms',
  'reject_recovery_enabled',
  'reject_recovery_max_reopens',
  'reject_recovery_sweep_interval_ms',
