...
const TIER_2 = [
  ...
  // Factory intake
  'create_work_item', 'list_work_items', 'update_work_item', 'reject_work_item', 'intake_from_findings', 'scan_plans_directory', 'list_plan_intake_items', 'poll_github_issues', 'architect_log',
  // Factory loop
