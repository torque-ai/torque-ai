...
const TIER_1 = [
  ...
  // Factory
  'factory_status', 'factory_automation_plan', 'pause_project', 'resume_project', 'pause_all_projects', 'project_health', 'trigger_architect', 'architect_backlog',
  // Schedule management
...
const TIER_2 = [
  ...
  // Factory (extended)
  'register_factory_project', 'list_factory_projects', 'scan_project_health', 'rescore_all_projects', 'set_factory_trust_level', 'apply_factory_automation_plan', 'arm_factory_tick', 'get_project_policy', 'set_project_policy',
  // Factory intake
