...
const PASSTHROUGH_CASES = [
  ...
  { method: 'POST', path: '/api/v2/study/evaluate', tool: 'evaluate_codebase_study', domain: 'study' },
  { method: 'POST', path: '/api/v2/study/benchmark', tool: 'benchmark_codebase_study', domain: 'study' },
  { method: 'POST', path: '/api/v2/study/preview', tool: 'preview_codebase_study_bootstrap', domain: 'study' },
  { method: 'POST', path: '/api/v2/study/bootstrap', tool: 'bootstrap_codebase_study', domain: 'study' },
