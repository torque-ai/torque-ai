...
const INLINE_TOOL_HANDLERS = new Set(['ping', 'restart_server', 'restart_status', 'unlock_all_tools', 'unlock_tier', 'get_tool_schema', 'coord_status', 'get_task_log_disk_usage']);
