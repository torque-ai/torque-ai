...
describe('E2E: Hashline-Ollama execution', () => {
  ...
  it('Ollama failure in hashline mode: task fails gracefully', async () => {
  ...
  it('task records provider as hashline-ollama', async () => {
  ...
  it('no file references: falls back to review-like behavior', async () => {
