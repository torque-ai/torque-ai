...
test('handlers should not use raw throw Error() usage', () => {
  ...
  const UTILITY_FILES = new Set(['task-utils.js', 'shared.js', 'error-codes.js', 'snapscope-handlers.js', 'comparison-handler.js', 'review-handler.js', 'factory-handlers.js', 'recovery-inbox-handlers.js']);
  const files = fs
