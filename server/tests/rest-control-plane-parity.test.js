...
installCjsModuleMock('../api/v2-task-handlers', handlerModule([
  ...
  'handleSubmitTask', 'handleListTasks', 'handleKanbanSummary', 'handleCommandCenterSummary',
  ...
  'handleCommitTask', 'handleDeleteTask', 'handleApproveTask', 'handleRejectTask',
  'handleApproveTaskBatch', 'handleApproveSwitch', 'handleRejectSwitch',
...
installCjsModuleMock('../api/v2-governance-handlers', handlerModule([
  ...
  'handleGetProjectConfig', 'handleSetProjectConfig',
...
installCjsModuleMock('../api/v2-infrastructure-handlers', handlerModule([
  ...
  'handleSaveCredential', 'handleDeleteCredential', 'handleRevealCredential', 'handleListAgents',
