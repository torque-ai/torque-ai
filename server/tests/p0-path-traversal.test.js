...
describe('Path traversal hardening', () => {
  ...
  // async readModifyWrite helper). Path-traversal checks return the error
  // object before any await, but because the function is `async` the return
  // is a Promise. Tests must await.
