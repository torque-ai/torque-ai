...
describe('db/backup-core', () => {
  ...
  it('creates scheduled backups and removes files beyond the retention limit', () => {
    ...
    expect(fs.unlinkSync).toHaveBeenCalledWith(path.join(prunedBackupDir, 'torque-2026-01-01T12-00-00-000Z.db'));
    expect(fs.unlinkSync).toHaveBeenCalledWith(path.join(prunedBackupDir, 'torque-2026-01-01T12-00-00-000Z.db.sha256'));
