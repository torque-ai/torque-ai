...
const {
  ...
  // Cross-cluster deps passed as their source-cluster objects, not flat.
  // Each is a createXxx() factory output; plan-execute.js destructures the
  // members it needs. Keeps the createPlanExecuteStage seam at 41 deps.
