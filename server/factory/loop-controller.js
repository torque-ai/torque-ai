...
// Codegraph integration block. Only emitted when the plugin is enabled
// (TORQUE_CODEGRAPH_ENABLED=1) — otherwise the planner would be told about
// tools that don't exist and fail when calling them. The block teaches the
