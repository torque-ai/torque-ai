...
const BENIGN_FLOW_ACTION_EXACT = new Set([
  ...
  'start_loop_blocked_active_instance', // SENSE refused a duplicate loop start because an existing instance is already in SENSE
  ...
  'generated_plan_restored_after_worktree_prepare', // EXECUTE restored captured generated plan after worktree prep
