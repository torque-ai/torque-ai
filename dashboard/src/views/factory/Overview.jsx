...
export default function Overview() {
  ...
  if (!selectedProject) {
    return <SelectProjectPrompt message="Select a project above to view its loop state, recent activity, and cycle history." />;
  }
      ...
      <section className="rounded-2xl border border-slate-700 bg-slate-800 p-6">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400">Per-project loop state — refreshes when projects are reloaded.</p>
          </div>
        </div>
